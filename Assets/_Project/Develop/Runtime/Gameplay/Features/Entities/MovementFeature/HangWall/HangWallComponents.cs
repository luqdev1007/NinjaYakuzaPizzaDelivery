...
namespace Assets._Project.Develop.Runtime.Gameplay.Features.Entities.MovementFeature.HangWall
{
    ...
    public class IsWallHanging : IEntityComponent
    {
        public ReactiveVariable<bool> Value = new();
    }

    public class WallHangSlideSpeed : IEntityComponent
    {
        public ReactiveVariable<float> Value;
    }

    public class WallHangLayer : IEntityComponent
    {
        public LayerMask Value;
    }

    public class WallJumpForce : IEntityComponent
    {
        public ReactiveVariable<Vector2> Value;
    }

    public class WallDirection : IEntityComponent
    {
