...
namespace Assets._Project.Develop.Runtime.Configs.Gameplay.Style
{
    ...
    public class StyleActionsConfig : ScriptableObject
    {
        ...
        [Tooltip("Разруб языка слайма — в полёте или уже вцепившегося в героя.\n" +
                 "Выше WallJumpPoints осознанно: это реактивное скилловое действие в " +
                 "узком окне, а не техника, которую игрок инициирует в удобный момент.\n" +
                 "Начисляется и за разруб катаной, и за срез тараном на скорости")]
        public float TongueCutPoints = 18f;
