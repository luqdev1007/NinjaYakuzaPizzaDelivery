...
namespace Assets._Project.Develop.Runtime.Configs.Gameplay.Entities
{
    ...
    public class SlopeSettings
    {
        ...
        [field: SerializeField] public float SlideOffDelay { get; private set; } = 0.1f;
        ...
        [field: SerializeField] public Vector2 JumpForce { get; private set; } = new Vector2(10f, 6f); // jump settings
    }
