...
namespace Assets._Project.Develop.Runtime.UI.Core.GameSettings
{
    public class GameSettingsPopupView : PopupViewBase
    {
        ...
        [field: SerializeField] public Button OpenGraphicSettings { get; private set; }
        [field: SerializeField] public Button OpenLanguageSettings { get; private set; }
        [field: SerializeField] public Button OpenKeyBindingsSettings { get; private set; }
