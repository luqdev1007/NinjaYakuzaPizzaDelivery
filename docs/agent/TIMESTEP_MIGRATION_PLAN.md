...
> **✅ МИГРАЦИЯ ЗАВЕРШЕНА И ПРИНЯТА (15.07.2026).** Все 9 этапов закрыты и
> подтверждены плейтестом; финальная приёмка пройдена — стильные связки
> fps-инвариантны на 30/60/144/200 (§8.4). Задача закрыта.
>
> Итог, вскрывшиеся дочистки, оставшийся техдолг и чек-лист приёмки — в **§8**.
> Оставшийся долг (R5–R9) — отдельные заходы, не блокеры.
>
...
> **✅ ПРИЁМКА ПРОЙДЕНА — 15.07.2026. Миграция принята.**
> Все **семь связок** ниже воспроизводятся одинаково по таймингам между
> **30 / 60 / 144 / 200 fps**. Критерий приёмки выполнен.
>
> Связка **grapple → ранний отпуск → plunge** — расхождение в пределах
> **известного R5** (летящая фаза крюка на корутине, Update-частота).
> Это **сознательный недетерминизм по решению F6, а не регрессия**: ровно то
> место, где fps-зависимость оставлена по дизайну. Закроется вместе с R5, когда
> детерминизм станет активной целью.
>
> **Активная задача миграции закрыта.** Дальнейшая работа по §8.3 (R5–R9,
> bootstrap-тупик генератора) — самостоятельные заходы, не продолжение этой
> задачи.
>
> **Реплеи / ghost-replay / лидерборды — запланированы, НЕ начаты.** Отдельная
> крупная фича, сопоставимая по объёму с миграцией; миграция — её фундамент, но
> не она сама. Входная заметка для будущей сессии: **`docs/agent/REPLAY_NOTES.md`**
> (что осталось сделать до реплеев, в каком порядке, и почему R5/R7 — первые).
